	...
	<div class="container-xl">
		<div class="row g-2 align-items-center">
			<div class="col">
				...
				<h1 class="page-title">Sinkronisasi Member</h1>
			</div>
		...
		<div class="row row-cards">
			<div class="col-lg-4">
				<?php if (! empty($can_run_sync)): ?>
					<div class="card admin-card mb-3 sync-action-card">
						<div class="card-body">
							<div class="sync-action-icon"><i class="ti ti-users-plus"></i></div>
							<h2 class="card-title mb-2">Tarik Member INLISLite</h2>
							<p class="text-secondary">Pilih mode agar prosesnya jelas: import hanya member baru, update menyegarkan member lama, dry run hanya simulasi tanpa menulis data.</p>
							<?= form_open('members/sync/run', ['class' => 'row g-2 align-items-end']); ?>
								<div class="col-12">
								...
								<div class="col-7">
									...
									<select class="form-select" name="limit">
										<option value="500">500 member</option>
										<option value="1000">1.000 member</option>
										<option value="2000">2.000 member</option>
									</select>
								</div>
								<div class="col-5">
									<button type="submit" class="btn btn-primary w-100" onclick="return confirm('Jalankan sinkronisasi member sekarang?')">
				...
				<div class="card admin-card mt-3">
					<div class="card-header">
						<h2 class="card-title">Akun Hasil Migrasi</h2>
					</div>
					<div class="card-body">
						<div class="datagrid">
							<div class="datagrid-item">
								<div class="datagrid-title">Role</div>
								<div class="datagrid-content"><span class="badge bg-green-lt">USER</span></div>
							</div>
							<div class="datagrid-item">
								<div class="datagrid-title">Password awal</div>
								<div class="datagrid-content"><code><?= html_escape($default_password); ?></code></div>
							</div>
							<div class="datagrid-item">
								<div class="datagrid-title">Status password</div>
								<div class="datagrid-content">Wajib diganti saat login pertama.</div>
							</div>
							<div class="datagrid-item">
			...
			<div class="col-lg-8">
				<div class="card admin-card mb-3">
					<div class="card-header">
						<h2 class="card-title">Cakupan Migrasi</h2>
					</div>
					<div class="table-responsive">
						<table class="table table-vcenter card-table">
							...
							<tbody>
								<?php foreach ($migration_plan as $row): ?>
									<tr>
										<td><code><?= html_escape($row['source']); ?></code></td>
										<td><code><?= html_escape($row['target']); ?></code></td>
										<td><?= html_escape($row['coverage']); ?></td>
									</tr>
								<?php endforeach; ?>
							</tbody>
						</table>
